    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'dump' => [
                ...
                /*
                 * Diagnostic stores are deliberately left out of the backup.
                 *
                 * A backup exists to restore the business: accounts, positions,
                 * orders, balances, audit history. Nobody has ever restored an
                 * HTTP request log to recover trading state, and carrying them
                 * made every dump ~650 MB — two minutes of multipart upload,
                 * which is exactly the exposure that let a Backblaze brownout
                 * kill six consecutive backups on 2026-07-28.
                 *
                 * Structure is still dumped (`--no-data` semantics come from
                 * `exclude_tables` keeping the CREATE TABLE), so a restored
                 * database boots with these tables present and empty.
                 *
                 * `api_request_logs` alone is 3.2 GB of the ~4 GB schema.
                 * Everything here is regenerated by normal operation and is
                 * already retention-pruned by `kraite:cron-purge-old-data`.
                 */
                'exclude_tables' => [
                    'api_request_logs',
                    'api_snapshots',
