...
test('parses string error codes from API responses', function () {
...
test('parses integer error codes from API responses', function () {
...
test('handles missing error code gracefully', function () {
...
test('handles missing msg gracefully', function () {
    $response = new Response(400, [], json_encode([
        'code' => '40001',
    ]));
...
test('handles empty JSON response gracefully', function () {
...
test('handles non-JSON response gracefully', function () {
...
test('friendlyMessage includes string error code', function () {
    $response = new Response(400, [], json_encode([
        'code' => '40808',
        'msg' => 'Parameter verification exception',
    ]));
...
test('friendlyMessage includes integer error code', function () {
    $response = new Response(400, [], json_encode([
        'code' => 10001,
        'msg' => 'Invalid parameter',
    ]));
...
test('friendlyMessage omits code when not present', function () {
    $response = new Response(400, [], json_encode([
...
test('handles regular exceptions without HTTP context', function () {
...
test('captures exception file and line', function () {
...
test('handles null code value in JSON', function () {
    $response = new Response(400, [], json_encode([
        'code' => null,
        'msg' => 'Error message',
    ]));
...
test('handles array code value in JSON (invalid format)', function () {
    $response = new Response(400, [], json_encode([
        'code' => ['invalid' => 'format'],
        'msg' => 'Error message',
    ]));
...
test('handles boolean code value in JSON (invalid format)', function () {
    $response = new Response(400, [], json_encode([
        'code' => true,
        'msg' => 'Error message',
    ]));
...
test('parses Bitget 400 Bad Request response correctly', function () {
...
test('parses Binance error response correctly', function () {
