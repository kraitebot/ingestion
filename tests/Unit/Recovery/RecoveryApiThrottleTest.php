...
it('leaves client-level request accounting to the HTTP boundary', function (): void {
    ...
    expect(is_subclass_of(BitgetThrottler::class, ClientLevelApiThrottler::class))->toBeTrue()
        ->and(is_subclass_of(TaapiThrottler::class, ClientLevelApiThrottler::class))->toBeTrue()
