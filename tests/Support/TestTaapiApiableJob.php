...
/**
 * Taapi-specific test job for testing TaapiExceptionHandler.
 * Uses the REAL TaapiExceptionHandler to test actual exception routing logic.
 *
 * Usage:
 *   $step = StepTester::createSteps([
 *       ['arguments' => [
 *           'accountId' => $account->id,
 *           'throw_exception_stub' => 'taapiRateLimited',  // Method name on ResponseException
 *       ]],
 *   ], TestTaapiApiableJob::class)[0];
 */
final class TestTaapiApiableJob extends BaseApiableJob
{
    ...
    {
        // Use REAL TaapiExceptionHandler
