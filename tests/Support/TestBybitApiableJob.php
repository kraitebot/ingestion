...
/**
 * Bybit-specific test job for testing BybitExceptionHandler.
 * Uses the REAL BybitExceptionHandler to test actual exception routing logic.
 *
 * Usage:
 *   $step = StepTester::createSteps([
 *       ['arguments' => [
 *           'accountId' => $account->id,
 *           'throw_exception_stub' => 'bybitIpRateLimited',  // Method name on ResponseException
 *       ]],
 *   ], TestBybitApiableJob::class)[0];
 */
final class TestBybitApiableJob extends BaseApiableJob
{
    ...
    {
        // Use REAL BybitExceptionHandler
