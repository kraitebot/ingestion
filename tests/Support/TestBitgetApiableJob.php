...
/**
 * BitGet-specific test job for testing BitgetExceptionHandler.
 * Uses the REAL BitgetExceptionHandler to test actual exception routing logic.
 *
 * Usage:
 *   $step = StepTester::createSteps([
 *       ['arguments' => [
 *           'accountId' => $account->id,
 *           'throw_exception_stub' => 'bitgetIpRateLimited',  // Method name on ResponseException
 *       ]],
 ...
 *   ], TestBitgetApiableJob::class)[0];
 */
final class TestBitgetApiableJob extends BaseApiableJob
{
    ...
    {
        // Use REAL BitgetExceptionHandler
