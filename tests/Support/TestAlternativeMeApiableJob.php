...
/**
 * AlternativeMe-specific test job for testing AlternativeMeExceptionHandler.
 * Uses the REAL AlternativeMeExceptionHandler to test actual exception routing logic.
 *
 * Usage:
 *   $step = StepTester::createSteps([
 *       ['arguments' => [
 *           'accountId' => $account->id,
 *           'throw_exception_stub' => 'alternativemeRateLimited',  // Method name on ResponseException
 *       ]],
 *   ], TestAlternativeMeApiableJob::class)[0];
 */
final class TestAlternativeMeApiableJob extends BaseApiableJob
{
    ...
    {
        // Use REAL AlternativeMeExceptionHandler
