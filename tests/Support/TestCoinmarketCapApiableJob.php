...
/**
 * CoinMarketCap-specific test job for testing CoinmarketCapExceptionHandler.
 * Uses the REAL CoinmarketCapExceptionHandler to test actual exception routing logic.
 *
 * Usage:
 *   $step = StepTester::createSteps([
 *       ['arguments' => [
 *           'accountId' => $account->id,
 *           'throw_exception_stub' => 'cmcRateLimitedMinute',  // Method name on ResponseException
 *       ]],
 *   ], TestCoinmarketCapApiableJob::class)[0];
 */
final class TestCoinmarketCapApiableJob extends BaseApiableJob
{
    ...
    {
        // Use REAL CoinmarketCapExceptionHandler
