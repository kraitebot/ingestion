...
/**
 * Binance-specific test job for testing BinanceExceptionHandler.
 * Uses the REAL BinanceExceptionHandler to test actual exception routing logic.
 *
 * Usage:
 *   $step = StepTester::createSteps([
 *       ['arguments' => [
 *           'accountId' => $account->id,
 *           'throw_exception_stub' => 'binanceRateLimited',  // Method name on ResponseException
 *       ]],
 ...
 *           'throw_exception_stub_args' => [120],  // retryAfterSeconds
 *       ]],
 *   ], TestBinanceApiableJob::class)[0];
 */
final class TestBinanceApiableJob extends BaseApiableJob
{
    ...
    {
        // Use REAL BinanceExceptionHandler
