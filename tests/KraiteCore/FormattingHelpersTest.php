...
it('formats quantity without float precision loss for large decimal strings', function () {
...
it('formats price without float precision loss for large decimal strings', function () {
    $exchangeSymbol = new ExchangeSymbol;
...
it('uses the current conclude direction job namespace in alignment confirmation flow', function () {
